        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
		          	...
		          	<div class="form-group">
		          		...
		          		<input type="text" name="product_name" id="product_name" class="form-control" required data-parsley-trigger="keyup" />
		          	</div>
                    <div class="form-group">
                        <label>Product Price</label>
                        <input type="text" name="product_price" id="product_price" class="form-control" required placeholder="10.00" data-parsley-pattern="^[0-9]*\.[0-9]{2}$" data-parsley-trigger="keyup" />
                    </div>
        		</div>
