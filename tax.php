        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
		          		...
		          		<input type="text" name="tax_name" id="tax_name" class="form-control" required data-parsley-trigger="keyup" />
		          	</div>
                    <div class="form-group">
                        <label>Tax Percentage</label>
                        <input type="text" name="tax_percentage" id="tax_percentage" class="form-control" placeholder="10.00" required data-parsley-pattern="^[0-9]{1,2}\.[0-9]{2}$" data-parsley-trigger="keyup" />
                    </div>
        		</div>
